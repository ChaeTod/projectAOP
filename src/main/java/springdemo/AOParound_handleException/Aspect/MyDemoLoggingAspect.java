package springdemo.AOParound_handleException.Aspect;
...
public class MyDemoLoggingAspect {
    ...
    @Around("execution(* springdemo.AOParound_handleException.Service.*.getFortune(..))")
    public Object aroundGetFortune(ProceedingJoinPoint proceedingJoinPoint) throws Throwable{
        ...
        // execute the method
        Object result = null;  // handle to target method && execute the target method

        try {
            result = proceedingJoinPoint.proceed(); // handing the exception here in our advice
        } catch (Exception e){
            // log the exception
    ...
    @After("execution(* springdemo.AOParound_handleException.DAO.AccountDAO.findAccounts(..))")
    ...
    @AfterThrowing(
            pointcut = "execution(* springdemo.AOParound_handleException.DAO.AccountDAO.findAccounts(..))",
            throwing = "exc"
    )
    ...
    @Before("springdemo.AOParound_handleException.Aspect.LuvAopExpressions.forDaoPackageNoGetterSetter()")
