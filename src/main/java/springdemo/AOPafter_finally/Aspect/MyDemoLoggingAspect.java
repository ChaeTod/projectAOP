...
import springdemo.AOPafter_finally.Account;
...
public class MyDemoLoggingAspect {
    ...
    @After("execution(* springdemo.AOPafter_finally.DAO.AccountDAO.findAccounts(..))")
    ...
    @AfterThrowing(
            pointcut = "execution(* springdemo.AOPafter_finally.DAO.AccountDAO.findAccounts(..))",
            throwing = "exc"
    )
    ...
    @Before("springdemo.AOPafter_finally.Aspect.LuvAopExpressions.forDaoPackageNoGetterSetter()")
