...
import springdemo.AOPafter_throwing.Account;
...
public class MyDemoLoggingAspect {
    ...
    @AfterThrowing(
            pointcut = "execution(* springdemo.AOPafter_throwing.DAO.AccountDAO.findAccounts(..))",
            throwing = "exc"
    )
    ...
    @Before("springdemo.AOPafter_throwing.Aspect.LuvAopExpressions.forDaoPackageNoGetterSetter()")
